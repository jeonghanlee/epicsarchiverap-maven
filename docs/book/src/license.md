...
Software: EPICS archiver appliance
    ...
    The "Software", below, refers to EPICS archiver appliance (in either source code, or binary form and accompanying documentation). Each licensee is addressed as "you" or "Licensee."
