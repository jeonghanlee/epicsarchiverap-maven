 ...
 */
@BPLEndpoint(
        summary = "Given a list of PVs, determine those that are not being archived/have pending requests/have aliases.",
        params = {
            @BPLParam(name = "pv", description = "A list of pv names. Send as a CSV using a POST or JSON array.")
        })
