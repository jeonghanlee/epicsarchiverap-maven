	...
	private static final String DATA_DIR = System.getProperty("archappl.tools.dataDir", System.getProperty("java.io.tmpdir"));
     ...
     long time1=System.currentTimeMillis();
                try {
                        ...
                        File zipFile =new File(DATA_DIR + "/200000pvsforoneday/result/2012_01_01.zip");
                        InputStream in=GZIPUtil.unpackZip(zipFile,"pv100000:2012_01_01.pb.gz");
                        //String filename=
                                        GZIPUtil.unGZFile(in, DATA_DIR + "/200000pvsforoneday/result/", "pv100000:2012_01_01.pb");
                        //System.out.println(filename);
                        //GZIPUtil.unziptarFile(in, "pv54:2012_03_31_11.pb", DATA_DIR + "/", "new_pv54:2012_03_31_11.pb");
        ...
        public static void getTimeOnePVForOneWeekFrom7ZipPBFileincluding5000pvsOneday()
        {
                ...
                try {
                        ...
                        for(int i=1;i<8;i++)
                        {
                        File zipFile =new File(DATA_DIR + "/morepvsforoneday/result/2012_01_0"+i+".zip");
                        InputStream in=GZIPUtil.unpackZip(zipFile,"pv0:2012_01_01.pb.gz");
                        //String filename=
                            GZIPUtil.unGZFile(in, DATA_DIR + "/morepvsforoneday/result/", "pv0:2012_01_0" + i + pbFileExtension);
                        //System.out.println(filename);
                        }
                        //GZIPUtil.unziptarFile(in, "pv54:2012_03_31_11.pb", DATA_DIR + "/", "new_pv54:2012_03_31_11.pb");
                        long time2=System.currentTimeMillis();
        ...
        {
                long time1=System.currentTimeMillis();
                File zipFile =new File(DATA_DIR + "/onepvperday/onePVALlPBOneYear.zip");
                try {
                        // search files for one week from 2012_06_01 to 2012_06_07
                        for(int i=1;i<8;i++)
                        {
                        ...
                        //String filename=
                            GZIPUtil.unGZFile(in, DATA_DIR + "/onepvperday/result/", "pv:2012_06_0" + i + pbFileExtension);
                        //System.out.println(filename);
                        }
                        //GZIPUtil.unziptarFile(in, "pv54:2012_03_31_11.pb", DATA_DIR + "/", "new_pv54:2012_03_31_11.pb");
                        long time2=System.currentTimeMillis();
        ...
        public static void getTimeonePVforOneHourPBFileFromOneMonthPBFile(){
                long time1=System.currentTimeMillis();
                File file =new File(DATA_DIR + "/all.zip");
                try {
